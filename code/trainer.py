...
class Trainer(object):
    def __init__(self, model, optim, device, train_dataloader, val_dataloader, test_dataloader, data_name, split,
                 **config):
        self.model = model
        self.optim = optim
        self.device = device
    ...
    def test(self, dataloader="test"):
        ...
        if dataloader == "test":
            ...
            data.to_csv('../output/visualization_BioSNAP.csv', index=False)
